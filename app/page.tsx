...
export default function Home() {
  return (
    <main className="flex flex-nowrap gap-10 min-h-screen flex-col items-stretch justify-center px-5 py-20 mx-auto bg-black">
      ...
      <div className="rounded-xl ring-[6px] text-yellow-700 ring-current ring-opacity-50 px-5 py-2 text-[4vw] uppercase  ">
        <Date />
      </div>
      <div className="grid grid-cols-3 gap-10 w-full">
        <div className=" rounded-xl ring-[6px] text-blue-700 ring-current ring-opacity-50 px-10  overflow-hidden aspect-square ">
          <h2>Information:</h2>
        </div>
